...
export default function DashboardPage() {
  ...
  // Permission checks removed - handled by SuspendedContent overlay
  const canAccess = isSuperAdmin || canAccessSection('dashboard');
  console.log('[DashboardPage] canAccess:', canAccess);
